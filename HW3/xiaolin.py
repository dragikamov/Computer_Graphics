...
usage: python xiaolin.py [output-file]
"""
...
def draw_line(img, p1, p2, color):
    ...
    for x in range(xstart, xend):
        ...
        print(x, y, _rfpart(intery))
        print(x, y+1, _fpart(intery))
        intery += grad
 
 
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print('usage: python xiaolin.py [output-file]')
        sys.exit(-1)
    ...
    draw_line(img, (10, 120), (18, 117), black)
